...
const NetworkError = () => {
  return (
    ...
    <div className="not-found-container" style={{margin: '20vh 60vw', textAlign: 'center', padding: '40px', borderRadius: '8px', maxWidth: '500px', width: '100%', fontFamily: 'Segoe UI'}}>
      ...
      <p className="not-found-message" style={{ fontFamily: 'Segoe UI', color: '#747474', padding: '20px' }}>Oops! It seems there was a problem connecting to the network, try reloading the page.</p>
      <Link to="/">
